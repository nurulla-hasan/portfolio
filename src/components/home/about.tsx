    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute left-0 right-0 top-[12%] h-px bg-border/20 overflow-hidden">
          <div className="absolute top-0 h-px w-16 bg-linear-to-r from-transparent to-primary" style={{ animation: 'walk-h 35s linear infinite 5s' }} />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 relative z-10 w-full">
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-16 lg:gap-32 items-center">
          ...
          <div className="flex flex-col items-start w-full">
            ...
            <h2 className={`${uniqueFont.className} text-[clamp(2rem,4vw,4rem)] leading-[0.95] font-black tracking-tighter uppercase mb-4 text-foreground`}>
              Building <br />
            ...
            <div className="relative border-l border-border/40 pl-8 py-1 space-y-4">
               ...
               <p className="text-[0.85rem] md:text-[0.9rem] font-medium leading-relaxed text-muted-foreground/60 max-w-lg">
                Specializing in authenticated dashboard systems, complex state management, and reusable enterprise-grade architectures using React, Next.js, and TypeScript.
               </p>
               ...
               <div className="pt-4 grid grid-cols-2 gap-6">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[0.5rem] tracking-[0.3em] font-bold uppercase text-muted-foreground">Years Experience</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-2xl font-black text-primary">40+</span>
                    <span className="text-[0.5rem] tracking-[0.3em] font-bold uppercase text-muted-foreground">Projects Delivered</span>
                  </div>
               </div>
            </div>
          </div>
            ...
            <div className="glass-terminal relative z-10 p-8 rounded-3xl overflow-hidden">
               ...
               <div className="flex items-center justify-between mb-8 border-b border-border/40 pb-4 relative z-10">
                  <div className="flex items-center gap-4">
                     ...
                     <div className="flex flex-col">
                        <span className="text-[0.6rem] font-bold tracking-[0.3em] uppercase text-foreground">Tech_Matrix.sys</span>
                        <span className="text-[0.4rem] font-medium tracking-[0.2em] uppercase text-muted-foreground/60">Version 4.0.2 // Build Active</span>
                     </div>
                  </div>
               ...
               <div className="grid gap-6 relative z-10">
                  ...
                  <div className="space-y-3">
                     <div className="flex items-center gap-3">
                        ...
                        <span className="text-[0.55rem] font-black tracking-[0.4em] uppercase text-primary">01. UI_Foundations</span>
                     </div>
                  ...
                  <div className="space-y-3">
                     <div className="flex items-center gap-3">
                        ...
                        <span className="text-[0.55rem] font-black tracking-[0.4em] uppercase text-sidebar-primary">02. State_Logic</span>
                     </div>
                     <div className="flex flex-wrap gap-2">
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="flex flex-wrap gap-2">
                        {["Git", "Vercel", "REST APIs"].map(s => (
                          <span key={s} className="skill-tag text-[0.65rem] px-3 py-1.5 font-bold tracking-wider text-muted-foreground rounded-lg border border-border/40 hover:bg-primary! hover:shadow-primary!">
                            {s}
                          </span>
                        ))}
                     </div>
