    ...
    >
      ...
      <div className="hidden lg:block absolute left-0 right-0 top-[10%] h-px bg-border/30 overflow-hidden z-0 pointer-events-none">
        <div
          ...
          style={{ animation: "walk-h 30s linear infinite 5s" }}
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 relative z-10 w-full py-24">
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col items-start w-full">
            ...
            <h2
              className={`${uniqueFont.className} text-[clamp(2.5rem,4vw,4rem)] leading-[1.05] font-semibold tracking-widest uppercase text-foreground mb-6`}
            >
              <span className="shimmer-text block mb-2 drop-shadow-[0_0_15px_var(--primary-foreground)]">
                Frontend Focused
              </span>
              <span
                className="block outline-scan text-[clamp(2.5rem,4vw,3rem)]"
                data-text="MERN Engineer"
              >
                MERN Engineer
              </span>
            </h2>
            ...
            <p className="text-[0.9rem] md:text-[1rem] font-light leading-relaxed text-muted-foreground max-w-xl mb-12 text-justify">
              Professional experience building authenticated, API-driven web
              applications and dashboard systems using React, Next.js,
              TypeScript, Tailwind CSS, and Redux Toolkit. I specialize in
              reusable component architecture, custom hooks, protected routing,
              validated forms, and feature-based frontend structures to deliver
              scalable codebases.
            </p>
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-8 border-l border-border/50 pl-8">
              <div className="flex flex-col gap-2">
                ...
                <span className="text-[0.85rem] font-medium text-foreground tracking-wide">
                  Web Applications
                </span>
              </div>
              <div className="flex flex-col gap-2">
          ...
          <div className="w-full h-full flex items-center justify-center relative mt-10 lg:mt-0">
            ...
            <div className="relative z-10 w-full p-8 md:p-10 rounded-2xl border border-border/60 flex flex-col gap-8 backdrop-blur-xl bg-background/40">
              {/* Terminal Header */}
              <div className="flex items-center justify-between border-b border-border/60 pb-5">
                <div className="flex items-center gap-3">
                  <Terminal className="w-4 h-4 text-primary" />
                  <span className="text-[0.65rem] tracking-[0.3em] font-medium uppercase text-muted-foreground">
                    Sys.Skills_Matrix
                  </span>
                </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-3">
                  <span className="text-[0.55rem] font-bold tracking-[0.25em] text-primary/80 uppercase">
                    01 / Core Frontend
                  </span>
                  <div className="flex flex-wrap gap-2.5">
                    {[
                      ...
                      <span
                        key={skill}
                        className="text-[0.7rem] font-medium px-3.5 py-1.5 bg-foreground/5 border border-border/50 text-foreground/90 rounded-md hover:border-primary/50 transition-colors cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {[
                      ...
                      <span
                        key={skill}
                        className="text-[0.7rem] font-medium px-3.5 py-1.5 bg-foreground/5 border border-border/50 text-foreground/90 rounded-md hover:border-sidebar-primary/50 transition-colors cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                {/* Block 3 */}
                <div className="flex flex-col gap-3">
                  <span className="text-[0.55rem] font-bold tracking-[0.25em] text-destructive/80 uppercase">
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {["Git", "GitHub", "Vercel"].map((skill) => (
                      <span
                        key={skill}
                        className="text-[0.7rem] font-medium px-3.5 py-1.5 bg-foreground/5 border border-border/50 text-foreground/90 rounded-md hover:border-destructive/50 transition-colors cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
